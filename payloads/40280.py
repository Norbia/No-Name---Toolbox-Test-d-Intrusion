...
# The idea is that after the evil payload is injected by the first packet, it needs to be triggered by an authentication event. Whether the authentication succeeds or not does not matter.
